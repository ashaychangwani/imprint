...
const pipeline = [
  ...
  },
  {
    step: '02',
    title: 'Compile state',
    body: 'Generate state-aware API workflows with DOM playbooks as the final fallback. Focused researchers prove working calls, then the master plans and builds. Establish what response values mean and how callers obtain required inputs. Defer uncertain optional fields; keep failures visible for repair.',
